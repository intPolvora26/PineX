...
<section class="pt-32 pb-20 bg-pinex-dark text-white relative overflow-hidden animate-fade-in">
    <div class="absolute inset-0 bg-[url('/assets/images/contact-bg.jpg')] bg-cover bg-center opacity-30 animate-zoom-in animate-delay-100"></div>
    <div class="container mx-auto px-4 xl:px-0 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 font-title leading-tight animate-slide-up">Contáctanos</h1>
            <p class="text-xl md:text-2xl text-gray-200 mb-8 animate-slide-up animate-delay-100">Estamos disponibles para atenderte directamente</p>
        </div>
    </div>
</section>

<!-- Sección de Contacto Directo con animaciones escalonadas -->
<section class="py-20 bg-white">
    <div class="container mx-auto px-4 xl:px-0">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            
            <!-- Tarjeta WhatsApp -->
            <div class="bg-gray-50 p-8 rounded-xl shadow-sm border border-gray-200 hover:border-pinex-accent transition-all duration-300 transform hover:-translate-y-2 hover:shadow-lg text-center animate-slide-up animate-delay-200">
                <div class="bg-pinex-primary/10 text-pinex-primary rounded-full w-20 h-20 flex items-center justify-center text-3xl mb-6 mx-auto transition-all duration-500 hover:bg-pinex-primary hover:text-white">
                    <i class="fab fa-whatsapp animate-pulse"></i>
                </div>
            ...
            <!-- Tarjeta Llamada -->
            <div class="bg-gray-50 p-8 rounded-xl shadow-sm border border-gray-200 hover:border-pinex-accent transition-all duration-300 transform hover:-translate-y-2 hover:shadow-lg text-center animate-slide-up animate-delay-300">
                <div class="bg-pinex-primary/10 text-pinex-primary rounded-full w-20 h-20 flex items-center justify-center text-3xl mb-6 mx-auto transition-all duration-500 hover:bg-pinex-primary hover:text-white">
            ...
            <!-- Tarjeta Email -->
            <div class="bg-gray-50 p-8 rounded-xl shadow-sm border border-gray-200 hover:border-pinex-accent transition-all duration-300 transform hover:-translate-y-2 hover:shadow-lg text-center md:col-span-2 animate-slide-up animate-delay-400">
                <div class="bg-pinex-primary/10 text-pinex-primary rounded-full w-20 h-20 flex items-center justify-center text-3xl mb-6 mx-auto transition-all duration-500 hover:bg-pinex-primary hover:text-white">
...
<!-- Mapa y Dirección con animación -->
<section class="py-20 bg-gray-50 animate-fade-in animate-delay-500">
    <div class="container mx-auto px-4 xl:px-0">
        <div class="max-w-4xl mx-auto text-center mb-12">
            <h2 class="text-3xl font-bold mb-4 font-title text-pinex-dark animate-slide-up">Visítanos</h2>
            <p class="text-gray-600 max-w-2xl mx-auto animate-slide-up animate-delay-100"><?= ADDRESS ?></p>
        </div>
        
        <div class="aspect-w-16 aspect-h-9 bg-gray-200 rounded-xl overflow-hidden animate-zoom-in">
            <iframe 
